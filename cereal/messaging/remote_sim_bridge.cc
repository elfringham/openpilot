...
int main(int argc, char** argv) {
  ...
  std::string servicelist_sim_str = "camerad,can,pandaStates,gpsLocationExternal,driverStateV2,peripheralState,roadCameraState,wideRoadCameraState";
  //std::string servicelist_sim_str = "camerad,can,pandaStates,accelerometer,gyroscope,gpsLocationExternal,driverStateV2,driverMonitoringState,peripheralState,roadCameraState,wideRoadCameraState";
